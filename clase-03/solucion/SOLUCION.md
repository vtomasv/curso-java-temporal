# Clase 03 — Resolución paso a paso

Esta guía explica una forma correcta y didáctica de resolver la clase centrada en **Depuración, pruebas unitarias y JavaDoc**. Debe leerse después de intentar los ejercicios de la carpeta `ejercicios/`, idealmente ejecutando pruebas y revisando cada cambio con apoyo de IA.
...
Antes de corregir, escribe un test que falle y describa claramente el comportamiento esperado.
...
## Paso 2. Corregir la implementación mínima

Aplica el cambio más pequeño posible para hacer pasar el test sin introducir efectos laterales.

La decisión didáctica aquí es mantener la solución incremental: primero se establece el contrato, luego la implementación y finalmente la verificación con pruebas. Esto permite que el estudiante use la IA como asistente de diseño y depuración, no como sustituto de comprensión.

## Paso 3. Documentar el módulo

Agrega JavaDoc a clases y métodos públicos explicando contrato, parámetros y retorno.
...
|---|---|---|
| Corregir sin test previo | No puedes asegurar que el bug quedó cubierto | Primero escribir la prueba roja |
| JavaDoc que repite el nombre del método | No aporta valor real | Documentar propósito y restricciones |

# Clase 15 — Resolución paso a paso

Esta guía explica una forma correcta y didáctica de resolver la clase centrada en **Mensajería asíncrona, validación y AOP**. Debe leerse después de intentar los ejercicios de la carpeta `ejercicios/`, idealmente ejecutando pruebas y revisando cada cambio con apoyo de IA.
...
## Paso 1. Publicar eventos del dominio

Desacopla el emisor del consumidor usando eventos o listeners asíncronos.
...
## Paso 2. Validar contratos de entrada

Aplica Bean Validation a DTOs y crea validadores personalizados cuando la anotación estándar no alcance.

La decisión didáctica aquí es mantener la solución incremental: primero se establece el contrato, luego la implementación y finalmente la verificación con pruebas. Esto permite que el estudiante use la IA como asistente de diseño y depuración, no como sustituto de comprensión.

## Paso 3. Auditar con aspectos

Usa AOP para medir tiempos o registrar invocaciones sin contaminar la lógica principal.
...
|---|---|---|
| Poner validaciones complejas en el controlador | Responsabilidades difusas | Encapsular reglas en validadores o servicios |
| Usar AOP para lógica de negocio | Dificulta el seguimiento | Reservar AOP a concerns transversales |

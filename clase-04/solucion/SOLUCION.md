# Clase 04 — Resolución paso a paso

Esta guía explica una forma correcta y didáctica de resolver la clase centrada en **Colecciones, streams y concurrencia básica**. Debe leerse después de intentar los ejercicios de la carpeta `ejercicios/`, idealmente ejecutando pruebas y revisando cada cambio con apoyo de IA.
...
## Paso 1. Resolver consultas con Streams

Aplica filter, map y collect para obtener subconjuntos de eventos sin modificar la colección original.
...
## Paso 2. Construir estadísticas agregadas

Usa groupingBy, counting y summarizing para resumir tráfico por protocolo, origen o severidad.

La decisión didáctica aquí es mantener la solución incremental: primero se establece el contrato, luego la implementación y finalmente la verificación con pruebas. Esto permite que el estudiante use la IA como asistente de diseño y depuración, no como sustituto de comprensión.

## Paso 3. Introducir concurrencia controlada

Procesa varias entradas en paralelo con un executor y deja la lógica pura separada del mecanismo de ejecución.
...
|---|---|---|
| Mutar estado compartido desde varios hilos | Resultados no deterministas | Usar colecciones seguras o reducir estado compartido |
| Streams demasiado complejos | Código difícil de leer | Extraer operaciones intermedias a métodos descriptivos |

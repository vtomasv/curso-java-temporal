# Clase 02 — Resolución paso a paso

Esta guía explica una forma correcta y didáctica de resolver la clase centrada en **Excepciones, logging y clases internas**. Debe leerse después de intentar los ejercicios de la carpeta `ejercicios/`, idealmente ejecutando pruebas y revisando cada cambio con apoyo de IA.
...
## Paso 1. Definir excepciones del dominio

Crea una jerarquía de excepciones para distinguir datos faltantes, formato inválido y errores de lectura.
...
## Paso 2. Agregar lectura segura de archivos

Usa try-with-resources para garantizar el cierre automático del lector, incluso cuando hay fallos.

La decisión didáctica aquí es mantener la solución incremental: primero se establece el contrato, luego la implementación y finalmente la verificación con pruebas. Esto permite que el estudiante use la IA como asistente de diseño y depuración, no como sustituto de comprensión.

## Paso 3. Incorporar logging estructurado

Reemplaza salidas por consola por logs con contexto suficiente para depurar entradas inválidas y reintentos.
...
|---|---|---|
| Capturar Exception genérica | Oculta la causa real del fallo | Capturar excepciones concretas y propagar contexto útil |
| No registrar la causa original | La traza pierde valor diagnóstico | Loguear mensaje + excepción completa |
